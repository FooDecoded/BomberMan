...
class Player extends Entity {
    ...
    getFrameName(){
        if(this.moving && this.direction.x == 1 && this.direction.y == 0){
            ...
            return `right-${this.currentFrameIndex}`
        } else if(this.moving && this.direction.x == -1 && this.direction.y == 0){
            this.calculateNextFrame()
            return `left-${this.currentFrameIndex}`

        } else if(this.moving && this.direction.x == 0 && this.direction.y == 1){
            this.calculateNextFrame()
            return `down-${this.currentFrameIndex}`

        } else if(this.moving && this.direction.x == 0 && this.direction.y == -1){
            this.calculateNextFrame()
            return `top-${this.currentFrameIndex}`
        } else if(!this.moving){
            return `idle`
        }
    }
    ...
    draw(context) {
        this.sprite.draw('idle', this.game.context, this.pos.x, this.pos.y);
    }
